...
#### 层面二：计算神经科学层面 (Computational Neuroscience Level) —— 意识的计算基础
...
我们仍然假设每篇论文的权重一致，则计算神经科学层面的整体支持度如下：
...
该数字表明，以计算神经科学的意识理论评估AI，现有研究成果支持AI具有意识的程度大约是37.75%。请注意，该数字不具有任何实证价值，计算过程包含大量主观判断，请谨慎参考。
...
* 框架角度  
  * 将AI意识拆分到哲学、计算神经科学、心理学三个层面本身就值得质疑。这是一种投票式的评估方法，而非科学、严谨地证明AI意识。  
